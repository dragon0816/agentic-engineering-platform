...
4. Read the active phase specification, currently `docs/phases/PHASE_4_KNOWLEDGE.md`.
5. Read `HANDOFF.md`.
...
`docs/phases/PHASE_4_KNOWLEDGE.md` defines the current implementation scope. `HANDOFF.md` records resumable execution state, not architecture.
