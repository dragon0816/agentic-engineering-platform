...
4. Read the active phase specification, currently `docs/phases/PHASE_5_GATEWAY.md`.
5. Read `HANDOFF.md`.
...
`docs/phases/PHASE_5_GATEWAY.md` defines the current implementation scope. `HANDOFF.md` records resumable execution state, not architecture.
