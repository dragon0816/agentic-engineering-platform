...
the owner decision of 2026-09-23, and only the owner can produce it. 76 pull requests merged (#1 to #80; #5 was closed unmerged and superseded
...
stood at 64 while fourteen of those had merged, counted against GitHub on
...
The suite is 1094 passed, 4 skipped on Windows, with `ruff`, `mypy`,
